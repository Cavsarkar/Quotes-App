...
struct ContentView: View {
        ...
        ZStack {
            ...
            HStack {
                ...
                VStack{
                    ...
                    .padding(.all)
                    .background(AnimatedImage(url: URL(string: imageUrl?.urls.regular ?? "No url")))
                    // .background(Image(uiImage: "https://images.unsplash.com/photo-1623265174181-4095a1a35702".load()))
                    .cornerRadius(15)
                    .shadow(radius: 20)
    ...
    private func loadQuoteData() {
        guard let url = URL(string: "https://zenquotes.io/api/quotes/613bcce458648882af2fff80e5cb46799b4fbf70") else {
            return
        }
    ...
    private func loadImageData() {
        guard let url = URL(string: "https://api.unsplash.com/photos/random/?topics=nature&client_id=oFqCqq9h5M-DYXtR2vsTfnhu6gMozvH5fi3iZnY6XMM") else {
            return
        }
